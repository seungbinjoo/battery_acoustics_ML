...
os.chdir("/Users/seungbinjoo/Desktop/UCL FUSE Internship/Work/5 Experiments/Cylindrical Cell AE Matrix Experiment/Cylindrical Cell AE Matrix Experiment Aged 1C/AEwin Data")
cwd = os.getcwd()
print(cwd)


# What is the name of the experiment?
experiment_name = 'Cylindrical_Cell_Experiment_Pristine_1C'
...
for folder in new_folder_names:
    ...
    for file in csv_files:
        ...
        fig, ax = plt.subplots(figsize=(12, 6))
        ax.plot(x,filtered,linewidth=1.8, color='tab:red')
        ax.set_xlim([0, 409.6])
        ax.locator_params(axis='x', nbins=12)
        ax.locator_params(axis='y', nbins=7)
        ax.set_xlabel('Time (us)', fontsize=18)
...
for folder in new_folder_names:
    ...
    for file in csv_files:
        ...
        fig, ax = plt.subplots(figsize=(12, 6))
        ax.plot(xf_positive, magnitude_positive, linewidth=1.8, color='tab:green')  # Plot positive frequencies
